...
function Cursos() {
      useEffect(() => {
        document.body.className = Styles.CursosBody;
        return () => {
...
const [isExiting2, setIsExiting2] = useState(false);
    ...
    Quais <span>Cursos<br />Você Gostaria?</span>
            ...
            <div className={Styles.buttons}>
                ...
                {currentPage < cursosOption.length - 1 && <button onClick={() => changePage(currentPage + 1)}><svg width="42" height="44" viewBox="0 0 42 44" fill="none" xmlns="http://www.w3.org/2000/svg">
